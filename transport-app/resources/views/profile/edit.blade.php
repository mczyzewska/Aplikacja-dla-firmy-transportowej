...
<div class="container mx-auto p-6 max-w-4xl">
    ...
    {{-- 2. KOMUNIKATY O SUKCESIE (Zasada: Zrozumiałość - role="status") --}}
    ...
    {{-- KARTA EDYCJI (Styl: górny pas 12px - Fioletowy dla Kadr/Profilu) --}}
    <div class="bg-white p-10 rounded-xl shadow-2xl border-2 border-gray-100 border-t-[12px] border-t-purple-600">
        <form action="{{ route('profile.update') }}" method="POST" novalidate>
            ...
            <div class="space-y-10">
                ...
                {{-- Sekcja: Dane Firmowe (Tylko dla Klienta) --}}
                @if($user->role === 'client')
