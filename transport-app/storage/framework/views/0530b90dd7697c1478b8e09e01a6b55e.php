    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white p-6 rounded-xl shadow-xl border-2 border-gray-100 border-t-[12px] border-t-blue-800">
                ...
                <form action="<?php echo e(route('admin.couriers.store')); ?>" method="POST" class="space-y-5" novalidate>
                    <?php echo csrf_field(); ?>
                    <div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y-2 divide-gray-50 text-sm">
                            ...
                            <tr class="hover:bg-blue-50 transition-colors">
                                <td class="p-5 font-black text-gray-900 uppercase tracking-tight"><?php echo e($c->name); ?></td>
                                <td class="p-5">
                                    <span class="bg-gray-100 border-2 border-gray-200 px-3 py-1 rounded font-mono text-xs font-black text-gray-700 italic shadow-sm">
                                        <?php echo e($c->vehicle_number); ?>

                                    </span>
                                </td>
                                <td class="p-5 font-bold text-gray-700"><?php echo e($c->phone); ?></td>
                                <td class="p-5">
                                    <div class="flex justify-center">
                                        <form action="<?php echo e(route('admin.couriers.destroy', $c)); ?>" method="POST" 
                                              onsubmit="return confirm('Czy na pewno chcesz usunąć kierowcę <?php echo e($c->name); ?> z floty?')">
                                            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                            <button aria-label="Usuń kierowcę: <?php echo e($c->name); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/magda/transport-app/resources/views/admin/couriers/index.blade.php ENDPATH**/ ?>