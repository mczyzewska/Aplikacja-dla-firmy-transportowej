...
<div class="container mx-auto p-6 max-w-5xl">
    ...
    <div class="flex flex-wrap items-center justify-between mb-10 border-b-4 border-blue-800 pb-4 gap-4">
        <h1 class="text-4xl font-black text-gray-900 uppercase tracking-tighter">
            Szczegóły Faktury: FV/<?php echo e($invoice->id); ?>
                ...
                <div class="space-y-3">
                    ...
                    <div class="mt-6 flex md:justify-end">
                        ...
                        <div role="status" 
                            ...
                            <?php echo e($isPaid ? '✔ Opłacona' : '✖ Oczekuje na wpłatę'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/magda/transport-app/resources/views/client/invoices/show.blade.php ENDPATH**/ ?>